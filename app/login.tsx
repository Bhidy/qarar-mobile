      ...
      >
        ...
        >
          ...
          <View style={s.formCard}>
            ...
            {/* ── Social sign-in (Apple first on iOS — Guideline 4.8 prominence) ── */}
            {showModeSwitcher && (
              <View style={s.socialBlock}>
                {Platform.OS === "ios" && (
                  socialBusy === "apple" ? (
                    <View style={[s.socialBtn, s.appleBtnBusy]}>
                ...
                <Pressable
                  ...
                  style={({ pressed }) => [
                    ...
                    s.googleBtn,
                    { flexDirection: isAr ? "row-reverse" : "row" },
                    (pressed || socialBusy === "google") && { opacity: 0.75 },
                    (busy || socialBusy !== null) && socialBusy !== "google" && { opacity: 0.5 },
                  ]}
                >
                  {socialBusy === "google" ? (
                  ...
                  <Text style={[s.googleBtnText, { fontFamily: ff("700") }]}>
                    {socialBusy === "google"
                      ? T("Connecting to Google…", "جارٍ الاتصال بـ Google…")
...
const s = StyleSheet.create({
  ...
  // ── Social sign-in block (Apple native button + Google bordered button) ──
  socialBlock: { gap: Spacing[3], marginBottom: Spacing[5] },
  socialBtn: {
    height: 52,
    borderRadius: 18,
    alignItems: "center",
  ...
  appleBtnBusy: { backgroundColor: "#000000" },
  googleBtn: {
    backgroundColor: BRAND.bg,
    borderWidth: 1,
  ...
  googleBtnText: { color: BRAND.ink, fontSize: 14 },
  socialDivider: { alignItems: "center", gap: 12, marginTop: Spacing[1] },
